...
heroImage:
    url: '/project/BOMBE/title.png'
website: https://ntnu.bombe.top/
github: https://github.com/April-Aries/bombe.git
pubDate: 'Dec 30 2024'
---
...
![ETW Patch - main](/project/BOMBE/ETWPatch-main.png)
...
![ETW Patch - PatchETW](/project/BOMBE/ETWPatch-PatchETW.png)
...
![ETW Patch - GetEtwEventWriteOffset](/project/BOMBE/ETWPatch-GetEventWriteOffset.png)

其中 `localNtdllAddress` 會透過 `GetLibraryAddress` 取得 *ntdll.dll* 中 `EtwEventWrite` 的位址
![ETW Patch - GetRemoteNtdllBaseAddress](/project/BOMBE/ETWPatch-GetRemoteNtdllBaseAddress.png)

另一個是 `localNtdllBaseAddress`，它會透過 `GetRemoteNtdllBaseAddress` 從當前 process 中尋找 *ntdll.dll* module 的 base address，
![ETW Patch - GetLibraryAddress](/project/BOMBE/ETWPatch-GetLibraryAddress.png)

`ModifyRemoteMemory` 函式會修改 `EtwEventWrite` 的第一個 instruction。311 行會將 virtual protect 打開，316 行會嘗試更改目標 byte
![ETW Patch - ModifyRemoteMemory](/project/BOMBE/ETWPatch-ModifyRemoteMemory.png)
...
![PPID Spoofing - main](/project/BOMBE/PPIDSpoofing-main.png)
...
![Memory Mapping - main](/project/BOMBE/MemoryMapping-main.png)
...
![Bypass File Access Monitor](/project/BOMBE/BypassFileAccessMonitor.png)
