...
![Scene: Cloud Computing](/project/FHEwEC/scene-cloud-computing.PNG)
...
![Scene: Standard Encryption](/project/FHEwEC/scene-encryption.PNG)
...
![Scene: problem](/project/FHEwEC/scene-FHE.PNG)
...
![Scene: problem](/project/FHEwEC/scene-problem.PNG)
...
![Alg: Setup](/project/FHEwEC/alg-setup.PNG)
...
![Alg: Encrypt - Policy Formulation](/project/FHEwEC/alg-encrypt-policy-add.PNG)
...
![Alg: Encrypt - Data Duplication](/project/FHEwEC/alg-encrypt-data-duplicate.PNG)
...
![Alg: Encrypt - Data Deconstruction](/project/FHEwEC/alg-encrypt-data-deconstruct.PNG)
...
![Alg: Encrypt - FHE Encryption](/project/FHEwEC/alg-encrypt-FHE.PNG)
...
![Alg: Evaluate - Policy Check](/project/FHEwEC/alg-evaluate-policy-add.PNG)
...
![Alg: Decrypt - Data Reconstruction](/project/FHEwEC/alg-decrypt-reconstruct-add.PNG)
...
![Alg: Validate](/project/FHEwEC/alg-validate-add.PNG)
...
![Alg: Encrypt - Policy Formulation](/project/FHEwEC/alg-encrypt-policy-mul.PNG)
...
![Alg: Evaluate - Policy check](/project/FHEwEC/alg-evaluate-policy-mul.PNG)
...
![Alg: Evaluate - FHE Evaluation](/project/FHEwEC/alg-evaluate-FHE-mul.PNG)
...
![Alg: Decrypt - FHE](/project/FHEwEC/alg-decrypt-FHE-mul.PNG)
![Alg: Decrypt - Data Reconstruction](/project/FHEwEC/alg-decrypt-reconstruct-mul.PNG)
...
![Alg: Validate](/project/FHEwEC/alg-validate-mul.PNG)
